[2:38 م، 2024/8/21] Rasha Saber: <!DOCTYPE html>
<html lang="en">
...
<body>
  …
[2:54 م، 2024/8/21] Rasha Saber: <!DOCTYPE html>
<html lang="en">
        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                @if($job['img'])
                <img src="{{ asset('storage/' . $job['img']) }}" alt="Job Image" style="width: 50px; height: 50px;">
                @else
                No Image
                @endif
              </td>
